...
export default function Module4Quiz() {
  ...
  const handleNext = () => {
    ...
    if (current < questions.length - 1) {
      ...
      submitQuizScoreToAPI("module-4", score);
    }
  };
  ...
  const keyLearnings = [
    "Equality means treating all children fairly, regardless of their background.",
    "Every child has equal rights and deserves respect and dignity.",
    "Fair treatment means no one should be left out because of differences.",
    "Creating equal opportunities helps all children succeed and be happy.",
  ];
